...
class PokerStatusMockitoTest {
	...
	void verificarPokerTest() {
		...
		assertEquals(Hand.POKER, pokerStatus.verify(c1, c2, c3, c4, c5));
	}
	...
	void verificarPokerRepeatedAcesTest() {
		...
		assertEquals(Hand.HIGHCARD, pokerStatus.verify(c1, c2, c3, c4, c5));
	}
	...
	void verificarColorTest() {
		...
		assertEquals(Hand.FLUSH, pokerStatus.verify(c1, c2, c3, c4, c5));
	}
	...
	void verificarTrioTest() {
		...
		assertEquals(Hand.THREEOFAKIND, pokerStatus.verify(c1, c2, c3, c4, c5));
	}
}
